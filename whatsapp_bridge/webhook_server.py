...
def generate_test_autoreply(item):
    ...
    if has_any(t, ["для клиента", "for client", "for my client", "representing a client", "представляю клиента"]):
        return (
            "Отлично. Тогда давайте зарегистрируем клиента и подберем правильные материалы. "
            "Пришлите, пожалуйста: имя клиента, страну/город, примерный бюджет, желаемые сроки просмотра "
            "и что ему важнее — готовая/почти готовая вилла или можно рассматривать виллы в строительстве."
        )
