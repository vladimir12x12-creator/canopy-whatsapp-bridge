...
def agent_carousel_template(language="en"):
    if language == "ru":
        return "canopy_agent_advantages_carousel_10_v2", "ru"
    return "canopy_agent_advantages_carousel_10_v2", "en_US"
...
def send_agent_carousel_v7(to, language="en"):
    ...
    image_names = [
        ...
        "carousel_v3_05_investment_c9_progress.jpg",
...
def create_canopy_template(template_key):
    ...
    if template_key in (
        ...
        carousel_samples = [
            ...
            ("__CAROUSEL10V3_INVEST_HANDLE__", ASSET_DIR / "carousel_v3_05_investment_c9_progress.jpg"),
